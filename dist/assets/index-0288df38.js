...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:nn,depthTest:!1,depthWrite:!1})}function da(){return new Tn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:as(),fragmentShader:`
		...
		`,blending:nn,depthTest:!1,depthWrite:!1})}function pa(){return new Tn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:as(),fragmentShader:`
